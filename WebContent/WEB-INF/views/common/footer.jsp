      	...
      	<div class="footer-company-info">
	      	<div class="footer-logo">
	      		<a class="footer-logo-link" href="">
		      		<img class="footer-logo-img" src="<%= request.getContextPath() %>/images/logo.png" alt="" />
		      		<img class="footer-logofont-img" src="<%= request.getContextPath() %>/images/logofont.png" alt="" />
	      		</a>
	      	</div>
			...
			<div class="footer-external-link">
				<a href=""><img class="external-link-img" src="<%= request.getContextPath() %>/images/youtube.png" alt="" /></a>
				<a href=""><img class="external-link-img" src="<%= request.getContextPath() %>/images/Instagram.jpg" alt="" /></a>
				<a href=""><img class="external-link-img" src="<%= request.getContextPath() %>/images/twitter.png" alt="" /></a>
				<a href=""><img class="external-link-img" src="<%= request.getContextPath() %>/images/facebook.png" alt="" /></a>
				<a href=""><img class="external-link-img" src="<%= request.getContextPath() %>/images/github.png" alt="" /></a>
			</div>
		</div>
      </div>
    </footer>
